        ...
        <div class="container py-5 h-75">
            <div class="row d-flex justify-content-center h-100">
                <div class="col-lg-8 col-xl-8">
                    <div class="container">
                        <h2>User's Notice Table</h2>
                        <p>You can view the details of a certain user.</p>        
                        <table class="table table-hover">
                            ...
                            <?php
                                ...
                                while ( $row = mysqli_fetch_assoc($result) ){
                                    print "<tr><td>".$row['userid_c']."</td><td>".$row['nickname_c']."</td><td>".$row['tp']."</td><td>Respond</td><td>".$row['dt']."</td><td>".$row['venue']."</td><td>".$row['contact']."</td><td>".$row['st']."</td></tr>";
                                }
                            ?>
                            </tbody>
                        </table>
