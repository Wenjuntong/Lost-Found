...
<html>
    ...
    <body class="bgimg">
        ...
        <nav class="navbar navbar-expand-lg navbar-light background">
            ...
            <p style="width:26%; margin:0 auto; font-size: larger;"><strong>All Pending Notice</strong></p>
        ...
        <div class="container py-5 h-75">
            <div class="row d-flex justify-content-center h-100">
                <div class="col-lg-8 col-xl-8">
                    <div class="container">
                        <h2>Pending Notice Table</h2>
                        <p>You can view and respond the details of all pending notices.</p>        
                        <table class="table table-hover">
                            ...
                            <?php
                                ...
                                while ( $row = mysqli_fetch_assoc($result) ){
                                    print "<form action='detail.php' method='post'><tr><td>".$row['nickname_c']."</td><td>".$row['tp']."</td><td>".$row['dt']."</td><td>".$row['venue']."</td><td>".$row['contact']."</td><td>".$row['st']."</td><input type='hidden' name='index' value='".$row['object_id']."'><td><input type='submit' class='button' value='View Details'></td></form><form action='respond.php' method='post'><input type='hidden' name='index' value='".$row['object_id']."'><td><input type='submit' class='button' value='Respond'></td></tr></form>";
                                }
                            ?>
                            </tbody>
                        </table>
