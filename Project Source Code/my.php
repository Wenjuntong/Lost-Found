...
<html>
    ...
    <body class="bgimg">
        ...
        <nav class="navbar navbar-expand-lg navbar-light background">
            ...
            <p style="width:23%; margin:0 auto; font-size: larger;"><strong>My Notice</strong></p>
        ...
        <div class="container py-5 h-75">
            <div class="row d-flex justify-content-center h-100">
                <div class="col-lg-8 col-xl-8">
                    <div class="container">
                        <h2>My Notice Table</h2>
                        <p>You can view the details of all your notices, including that are created and responded.</p>        
                        <table class="table table-hover">
                            ...
                            <?php
                                ...
                                $userquery = "SELECT * FROM notice WHERE userid_c = '$userid'";
                                $result=mysqli_query($connect, $userquery);
                                while ( $row = mysqli_fetch_assoc($result) ){
                                    print "<form action='detail.php' method='post'><tr><td>".$row['tp']."</td><td>Create</td><td>".$row['dt']."</td><td>".$row['venue']."</td><td>".$row['st']."</td><input type='hidden' name='index' value='".$row['object_id']."'><td><input type='submit' class='button' value='View Details'></td></tr></form>";
                                }
                                $userquery1="SELECT * FROM notice WHERE userid_r = '$userid'";
                                $result1=mysqli_query($connect, $userquery1);
                                while ( $row = mysqli_fetch_assoc($result1) ){
                                    print "<form action='detail.php' method='post'><tr><td>".$row['tp']."</td><td>Respond</td><td>".$row['dt']."</td><td>".$row['venue']."</td><td>".$row['st']."</td><input type='hidden' name='index' value='".$row['object_id']."'><td><input type='submit' class='button' value='View Details'></td></tr></form>";
                                }
                            ?>
                            </tbody>
                        </table>
